...
if (!file.exists(samples_file)) {
  ...
  # Get last samples base (v12a)
  v12a_file <- file.path(samples_dir, glue("samples-cer-v12a.rds"))
  v12a <- readRDS(v12a_file)

  v13a <- dplyr::bind_rows(list(v12a, silviculture))

  saveRDS(v13a, samples_file)

  v13a$time_series <- NULL
  class(v13a) <- class(v13a)[-1]
  v13a_sf <- terra::vect(
    v13a,
